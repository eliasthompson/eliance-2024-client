...
export type TwitchEventSubChatBoxMessage =
  ...
  | TwitchEventSubRevocationMessage<
      TwitchEventSubChannelChatMessageNotificationMessage['metadata'],
      TwitchEventSubChannelChatMessageNotificationMessage['payload'],
      TwitchEventSubChannelChatMessageNotificationMessage['payload']['subscription']
    >
  | TwitchEventSubChannelChatNotificationNotificationMessage
  | TwitchEventSubRevocationMessage<
      TwitchEventSubChannelChatNotificationNotificationMessage['metadata'],
      TwitchEventSubChannelChatNotificationNotificationMessage['payload'],
      TwitchEventSubChannelChatNotificationNotificationMessage['payload']['subscription']
    >;
