...
export const GlobalStyle = () => {
  const bodyBackgroundColor = window.obsstudio ? 'transparent' : '#121212';
  const rootBackgroundColor = window.obsstudio ? 'transparent' : '#226600';
  const rootBackgroundImage = window.obsstudio
    ? 'none'
